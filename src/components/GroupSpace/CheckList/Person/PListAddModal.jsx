...
const PListAddModal = ({
  ...
  const [createData, setCreateData] = useState({
    ...
    // place: "",
    place: clickedDiagram?.space_name || "",
    toClean: "",
    due_data: new Date(),
    name: selectedName,
  ...
  const onClickCreate = async () => {
    ...
    try {
      ...
      const req = {
        ...
        unit_item: createData.target === "person" ? createData.place : null,
      };
  ...
  return (
    <div className="PListAddModal">
      ...
      >
        <div className="selectedPlace">{createData.place}</div>
        <section className="createToClean">
          <div className="toClean_text">추가하실 to-clean을 입력하세요.</div>
          <textarea
            name="toClean"
        ...
        <section className="createDeadLine">
          <div className="deadLine_text" style={{ marginLeft: "0" }}>
            마감 기한
          </div>
          <DatePicker
