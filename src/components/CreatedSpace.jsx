        ...
        >
          ...
          {spaces.map((space, idx) => (
            <>
              ...
              {type === "GroupHome" || selectedData.space_type === 0 ? (
                // 그룹홈 도형/ 사이드바 그룹공간 클릭 시 뜰 그룹용 도형 (클릭 안됨)
                <div
                  key={idx}
                  className="groupDiagram"
                  style={{
                    gridColumn: `${space.start_x + 1} / span ${space.width}`, // space.start_x + 1 위치부터 space.width칸 차지
                    gridRow: `${space.start_y + 1} / span ${space.height}`, // space.start_y + 1 위치부터 space.height칸 차지
                ...
                <div
                  ...
                  onMouseOver={() => setHoverDiagram(space.space_name)}
