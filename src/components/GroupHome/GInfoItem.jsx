  ...
  return (
    <div className="GInfoItem">
      <section className="left">
        <img className="Badge_img" src={getBadgeImage(person.badgeId)} />
      ...
      <section className="right">
        ...
        <Button onClick={onClickTList} text={"청소 리스트"} type={"list"} />
        {/*
                ...
                */}
        {isClick && (
          <TListModal person={person} isOpen={isClick} onClose={onCloseTList} />
        )}
      </section>
    </div>
  );
