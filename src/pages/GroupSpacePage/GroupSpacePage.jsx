  ...
  useEffect(() => {
    const fetchSpaces = async () => {
      try {
        ...
        setIsSubspace(
          spaces.find((space) => space.space_name === selectedData.name)?.items
            .length !== 0
        );
      } catch (error) {
            ...
            <div className="middle">
              <TriggerStateContext.Provider value={trigger}>
                <div className="mostCleanNeeded">
                  <NeedClean onLoaded={handleComponentLoaded} />
                </div>
              </TriggerStateContext.Provider>
              {selectedData.space_type && owner !== selectedData.owner ? (
                ...
                <Button
                  ...
                  onClick={() => {
                    selectedData.owner === "all"
                      ? nav("/createSpace")
                      : nav(`/createItem/${selectedData.id}`, {
                          state: {
              ...
              <TriggerStateContext.Provider value={trigger}>
                <div className="space">
                  ...
                  {selectedData.space_type === 0 ? (
                    ...
                    <NoPersonSpace selectedData={selectedData} />
                  )}
                </div>
              </TriggerStateContext.Provider>
            </div>
